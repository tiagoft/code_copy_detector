...
MODULE_SLUG = "code_copy_detector"
...
setup(
    ...
    description="A detector for copied code",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/tiagoft/Code Copy Detector",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'code_copy_detector-cli={MODULE_SLUG}.main:app',
        ],
    },
